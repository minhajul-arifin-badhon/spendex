...
export default function FeaturesShowcase() {
	return (
		<div className="overflow-hidden py-8 bg-feature">
			...
			<FeatureSection
				title="Smart Merchant & Category Suggestions"
				description="Our intelligent system learns from your transactions and creates rule-based suggestions for merchant names and categories. The more you use Spendex, the smarter it gets at automatically organizing your expenses."
				image="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1000?height=600&width=800"
